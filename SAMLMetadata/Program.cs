...
namespace MetadataExample {
    class Program {
        ...
        private static SPSSODescriptor CreateSPSSODescriptor() {
            ...
            //Added for SingleLogoutService
            EndpointType SingleLogoutService = new EndpointType(SAMLIdentifiers.BindingURIs.HTTPRedirect, "https://demo.thebeastapps.com/beastsaml/SLOService.aspx", null);
            spSSODescriptor.SingleLogoutServices.Add(SingleLogoutService);
            ...
            assertionConsumerService1.Location = "https://demo.thebeastapps.com/beastsaml/AssertionConsumerService.aspx";
            ...
            //assertionConsumerService2.Location = "http://localhost:64712/SAML/AssertionConsumerService.aspx";
        ...
        private static EntityDescriptor CreateSPEntityDescriptor() {
            EntityDescriptor entityDescriptor = new EntityDescriptor();
            entityDescriptor.EntityID = new EntityIDType("https://demo.thebeastapps.com/beastsaml/");
            entityDescriptor.SPSSODescriptors.Add(CreateSPSSODescriptor());

            Organization organization = new Organization();
            organization.OrganizationNames.Add(new OrganizationName("thebeastapps", "en"));
            organization.OrganizationDisplayNames.Add(new OrganizationDisplayName("thebeastapps", "en"));
            organization.OrganizationURLs.Add(new OrganizationURL("www.thebeastapps.com", "en"));
            entityDescriptor.Organization = organization;

            ContactPerson contactPerson = new ContactPerson();
            contactPerson.ContactTypeValue = "System Admin";
        ...
        static void Main(string[] args) {
            ...
            x509Certificate = new X509Certificate2(spPrivateKeyFileName, "", X509KeyStorageFlags.MachineKeySet);
			SAMLMetadataSignature.Generate(xmlElement, x509Certificate.PrivateKey, x509Certificate);
			Console.WriteLine(xmlElement.OuterXml);
            ...
            ReadMetadata(xmlElement);
            File.WriteAllText(("C:\\SAML\\" + DateTime.Now.Date.Year + "_" + DateTime.Now.Date.Month + "_" + DateTime.Now.Date.Day + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "_" + "SP_SSO_metadata.xml"), xmlElement.OuterXml);
        }
    }
}
