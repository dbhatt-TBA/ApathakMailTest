...
public class ProductClassGeneric : IProductImage
{
    ...
    private string _ExportField = string.Empty;

    public string ExportField
    {
        get { return _ExportField; }
        set { _ExportField = value; }
    }

    #endregion

    #region constructor
    public ProductClassGeneric(string strProductID, string strConnectionID, string strUserID, string strCustomerID, string strSpecialImageID, string strActualProductID, ref ServerAgent sa, bool strIsSharedImage, string strInstanceID, string username)
    {
    ...
    public void createBeastImage(string strProductID, string strConnectionID, string strUserID, string strCustomerID, string strSpecialImageID, string strActualProductID, ref ServerAgent _sa, string username)
    {
        try
        {
            ...
            LogUtility.Info("ProductClassGeneric.cs", "createBeastImage()", logDesc);
            ...
            // Definations.BeastImageAppID eProductName = (Definations.BeastImageAppID)Enum.Parse(typeof(Definations.BeastImageAppID), strActualProductID);
            string eProductName = strActualProductID;
            LogUtility.Info("ProductClassGeneric.cs", "createBeastImage()ImpersonatedUser", "username:" + username + " ProductName:" + eProductName);
        ...
        catch (Exception ex)
        {
            ...
            LogUtility.Error("ProductClassGeneric.cs", "createBeastImage()", strErrorDesc, ex);
            throw;
        }
    }
    ...
    public void openBeastImage(string strProductID, string strConnectionID, string strUserID, string strCustomerID, string strSpecialImageID, string strActualProductID, ref ServerAgent _sa, string ConnectionIDSignalR, string username)
    {
        try
        {
            ...
            LogUtility.Info("ProductClassGeneric.cs", "openBeastImage()", logDesc);
        ...
        {
            string strErrorDesc = getLogDescForGenericInfo() + " MSG : " + ex.Message;
            LogUtility.Error("ProductClassGeneric.cs", "openBeastImage()", strErrorDesc, ex);
            throw;
        }
    }
    ...
    public void DocImage_StatusChanged(DOMDataDocStatus Status, string info)
    {
        try
        {
            ...
            LogUtility.Info("ProductClassGeneric.cs", "DocImage_StatusChanged()", logDesc);
        }
        catch (Exception ex)
        {
            string strErrorDesc = getLogDescForGenericInfo() + " MSG : " + ex.Message;
            LogUtility.Error("ProductClassGeneric.cs", "DocImage_StatusChanged()", strErrorDesc, ex);
            throw;
        }
    }
    ...
    void DocImage_DocumentStale()
    {
        try
        {
            ...
            string logDesc = getLogDescForGenericInfo();
            LogUtility.Info("ProductClassGeneric.cs", "DocImage_DocumentStale()", logDesc);
        }
        catch (Exception ex)
        {
    ...
    void DocImage_DocumentChanged(DOMDataNodeList changed)
    {
                ...
                switch (changed[i].NodeName)
                {
                    ...
                    case "ToolTip":
                        ...
                        if (cnode.get_NamedChild("ToolTip") != null)
                        {
                            ...
                            cometVOrder.Send_Message_To_Client_Group_Generic(GruopID, "updt", "tt", changed[i].ParentNode.NodeID, nValueT, HtmlClientID);
        ...
        {
            string strErrorDesc = getLogDescForGenericInfo() + " MSG : " + ex.Message;
            LogUtility.Error("ProductClassGeneric.cs", "DocImage_DocumentChanged()", strErrorDesc, ex);
        }
    }
    ...
    public void DocImage_DocumentAlive()
    {
        try
        {
            ...
            string logDesc = getLogDescForGenericInfo();
            LogUtility.Info("ProductClassGeneric.cs", "DocImage_DocumentAlive()", logDesc);
        }
        catch (Exception ex)
        {
    ...
    public void GetFullUpdate(string ConnectionIDSignalR)
    {
        ...
        {
            string strErrorDesc = getLogDescForGenericInfo() + " MSG : " + ex.Message;
            LogUtility.Error("ProductClassGeneric.cs", "GetFullUpdate()", strErrorDesc, ex);
            throw;
        }
    }
}
