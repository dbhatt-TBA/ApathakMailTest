<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SharedBeastApps.aspx.cs"
    Inherits="OpenF2.SharedBeastApps" Async="true" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (hashes.indexOf('localhost:') > 0) {
                //script.src = "http://172.30.1.99/BeastServiceStaging/signalr/hubs";
                //script.src = "http://localhost:4828/signalr/hubs";
                //script.src = "http://localhost:4828/signalr/hubs";
                //script.src = "http://localhost:4828/signalr/hubs";
            ...
            setVariableValue(SignalRService, SignalRSetup);
