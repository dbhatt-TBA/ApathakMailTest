...
function TWM_Func_GenerateSelectionTable(ArrDisplayArray) {
    ...
    try {
        ...
        if (isSafari) {
            $('.twmOptions').find('.dvSpinUpArrow').removeClass("dvSpinUpArrow").addClass("dvSpinUpSafari").text("+");
            $('.twmOptions').find('.dvSpinDownArrow').removeClass("dvSpinDownArrow").addClass("dvSpinDownSafari").text("-");
        }
    }
    catch (err) {
