    ...
    try {
        ...
        $.connection.hub.stateChanged(function (change) {
            ...
            switch (change.newState) {
                ...
                case 1: // connected
                    //debugger;
                    $("#SignalrStatus").removeClass("fa fa-circle red").addClass("fa fa-circle"); //.text("Connected");
                ...
                case 4: // disconnected
                    //debugger;
                    $("#SignalrStatus").removeClass("fa fa-circle").addClass("fa fa-circle red"); //.text("Connected");
        ...
        debugger;
        if (isHubSet == true) {
            var paraValues = UserID + "#" + CustomerID + "#" + instanceMode + "#" + $("#hdn_senderEmailId").val();
    ...
    try {
        ...
        if (updtEleTyp == "m") {
            ...
            if (updtTyp == "imgStatus") {
                if (eleVal == "True") {
                    //debugger;
                    $("#AppStatus").removeClass("fa fa-circle red").addClass("fa fa-circle"); //.text("Connected");
                    ...
                    //debugger;
                    $("#AppStatus").removeClass("fa fa-circle").addClass("fa fa-circle red"); //.text("Connected");
...
function setElementValueGeneric(Element, ElementVal, EleParent, eleID, updtTyp, updtEleTyp, EletDispStr) {
    try {
        ...
        if (updtTyp == "mnlupdt" && $(Element).hasClass("updt") == true) {
            ...
            //    return false;
            //}
            if (EleParent == 'vcm_calc_cds_switch_calculator' || EleParent == 'vcm_calc_bondYield'
                || EleParent == 'vcm_calc_bondYield_Manual' || EleParent == 'vcm_calc_CdsCalculator' || EleParent == 'BYCE0252') {
                return false;
            }
            if (aryClass != null) {
                $(Element).css({
